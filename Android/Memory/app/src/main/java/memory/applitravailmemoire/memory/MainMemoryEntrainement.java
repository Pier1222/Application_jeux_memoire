...
public class MainMemoryEntrainement extends AppCompatActivity {
    TextView tv_p1;
    ...
    private void checkEnd(){
        if(iv_11.getVisibility() == View.INVISIBLE &&
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MainMemoryEntrainement.this);
            alertDialogBuilder
                    .setMessage("Bravo vous avez gagné !!\n" +"Vous avez eu "+ playerPoints+"points.")
                    .setCancelable(false)
                    .setPositiveButton("Rejouer l'entraînement", new DialogInterface.OnClickListener() {
                    ...
                    .setNegativeButton("Arrêter l'entraînement", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            finish();
                        }
