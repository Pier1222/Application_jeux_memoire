public class Grille {
    private static final int NB_CASES_ACTIVES = 8;
    private static int NB_LIGNES = 3;
    private static int NB_COLONNES = 4;
    private Case[][] cases;
    private boolean[] valeursDispo; //Les cases auront une valeur entre 1 et 15, ainsi valeursDispo[0] indique si la valeur 1 peut être prise par une case
